...
import com.Users.beefood.activity.ChiTietActivity;
import com.Users.beefood.Interface.ItemClickListener;
...
public class MonAnAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public MonAnAdapter(Context context, List<SanPhamMoi> array) {
...
//            myViewHolder.giasp.setText(sanPham.getGiasp());
            ...
            myViewHolder.setItemClickListener(new ItemClickListener() {
                ...
                public void onClick(View view, int pos, boolean isLongClick) {
                    if (!isLongClick) {
                        ...
                        //gửi dữ liệu qua màng hình chi tiết
    ...
    public int getItemViewType(int position) {
        //nếu mảng ta get = null thì sẽ loading và ngược lại lấy data
